...
const embedlulz = new Discord.RichEmbed()
    .setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor 👿 !")
      .setColor(0x00AE86)
      .setDescription("n-uyar <kişi> komutu ile onu uyarabilir 🍒 ya da 🍒 n-kick <kişi> 🍒 veya 🍒 n-ban <kişi> komutlarını kullanarak onu sunucudan uzaklaştırabilirsin 🚀 !")
...
const youtube = new YouTube('AIzaSyB6odX3_iG5hDyD-GdbB4KdxydyCbo5M-s');
const queue = new Map();
...
client.on('message', async msg => {
	...
	if (command === 'n-çal') {
      ...
      .setColor('RANDOM')
    .setDescription('「:negative_squared_cross_mark:」 Lütfen Bir Ses Kanalına Giriş Yapınız !'));
		const permissions = voiceChannel.permissionsFor(msg.client.user);
		if (!permissions.has('CONNECT')) {
			return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
    .setTitle('「:negative_squared_cross_mark:」  Lütfen Bir Ses Kanalına Giriş Yapınız !'));
		}
		if (!permissions.has('SPEAK')) {
			 return msg.channel.sendEmbed(new Discord.RichEmbed()
      .setColor('RANDOM')
      .setTitle('「:negative_squared_cross_mark:」  Şarkıyı Çalamıyorum Bu Kanalda Konuşma Yetkim Yok !'));
        }
...
const dmembed = new Discord.RichEmbed()
  .setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor!")
    .setColor(0x00AE86)
    .setDescription(" " + msg.author.tag + " Sunucunda Reklam Yapıyor n-uyar komutu ile kişiyi uyara bilir n-ban Komutu İle Kişiyi Banlayabilirsin ")
  .addField("Kullanıcının mesajı:", "**" + msg.content + "**")
